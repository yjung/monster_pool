...
function queueLaden() {
	...
	ColladaLoader.load('assets/dae/queue.dae', function(collada) {// Einladen der Datei mit Referenz "collada"
		...
		game.queue = new Physijs.CylinderMesh(daeGeometrie, 
                new THREE.MeshLambertMaterial( { map: THREE.ImageUtils.loadTexture("assets/dae/tex/queue.jpg"), shading: THREE.SmoothShading } )
//                erstelleCelShadingMaterial("queueMat", // Bezeichnung
