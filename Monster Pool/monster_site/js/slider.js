...
function animiereSlider(sliderObjekt, startPos, zielPos, startRot, zielRot) {
	...
	tweenZuZiel = new TWEEN.Tween(aktuellerWert).to(richtungZiel, 3000).easing(TWEEN.Easing.Elastic.InOut);
	tweenZuStart = new TWEEN.Tween(aktuellerWert).to(richtungStart, 3000).easing(TWEEN.Easing.Elastic.InOut);
