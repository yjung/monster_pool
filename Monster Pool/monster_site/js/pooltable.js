...
{
    var friction = 0.1; // high friction
...
//            }
        ...
        for (var j = tischbestandteile; j < szenenbestandteile; j++) {
            ...
            //collider.addEventListener('collision', tableCollideEvent);
        }
        ;
    });
...
function erstelleHindernisse(ColladaLoader) {
    ...
    //2er Bumper loesung
    erstelleBumper(ColladaLoader, 11, 18, -16.5);
    erstelleBumper(ColladaLoader, 6, 18, -23);
