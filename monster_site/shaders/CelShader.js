...
fragmentShader: [
	...
	// Cel-Shading-Bestandteile
		...
		"	if (vlf >= 0.5) { gl_FragColor = vec4(mix( basecolor, vec3(1.0), mixFaktor), alpha); }",
		"}",
		...
		"	if (vlf >= 0.66) { gl_FragColor = vec4(mix( basecolor, vec3(1), mixFaktor), alpha); }",
		"}",
		...
		"	if (vlf >= 0.75) { gl_FragColor = vec4(mix( basecolor, vec3(1.0), mixFaktor), alpha); }",
		"}",

		" if(shadingStufen == 5){",
		"	if (vlf < 0.20) { gl_FragColor = vec4(mix( basecolor, vec3(0.0), mixFaktor), alpha); }",
		"	if (vlf >= 0.20) { gl_FragColor = vec4(mix( basecolor, vec3(0.25), mixFaktor), alpha); }",
		"	if (vlf >= 0.40) { gl_FragColor = vec4(mix( basecolor, vec3(0.45), mixFaktor), alpha); }",
		"	if (vlf >= 0.60) { gl_FragColor = vec4(mix( basecolor, vec3(0.65), mixFaktor), alpha); }",
		"	if (vlf >= 0.80) { gl_FragColor = vec4(mix( basecolor, vec3(1.0), mixFaktor), alpha); }",
		"}",
